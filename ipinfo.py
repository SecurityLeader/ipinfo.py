#!/usr/bin/python 
 ...
        print (" ") 
        slowprint("\033[1;36m =====================================") 
        slowprint("\033[1;33m|        Coded By SecurityLeader|") 
        slowprint("\033[1;36m =====================================") 
        slowprint("\033[1;91m|          leaderhacking123@gmail.com       |") 
        slowprint("\033[1;36m =====================================") 
        print (" ") 
 ...
        slowprint ("\033[1;33m" + "         [+] Tool Name     =>\033[1;36m" + " IP-Info") 
        slowprint ("\033[1;33m" + "         [+] Autor         =>\033[1;36m" + " Security_Leader") 
        slowprint ("\033[1;33m" + "         [+] Latest Update =>\033[1;36m" + " 17/3/2019") 
        slowprint ("\033[1;33m" + "         [+] Telegram       =>\033[1;36m" + " Leader_Security") 
        slowprint ("\033[1;33m" + "         [+] Github        =>\033[1;36m" + " Security Leader") 
        slowprint ("\033[1;91m -----------------------------------------------") 
        slowprint ("\033[1;95m" + "          [+] www.Google.com [+]         ") 
        slowprint ("\033[1;91m -----------------------------------------------") 
